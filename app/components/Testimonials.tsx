...
const testimonials = [
    {
        ...
        name: "Asli C.",
        org: "MD",
        image: "https://cascadia-consultive.s3.us-west-2.amazonaws.com/abs/img/clients/asli.jpg"
    },
    {
        ...
        name: "Johnny W.",
        org: "MD",
        image: "https://cascadia-consultive.s3.us-west-2.amazonaws.com/abs/img/clients/johnny.jpg"
    },
    {
        ...
        name: "Donna C.",
        org: "MD",
        image: "https://cascadia-consultive.s3.us-west-2.amazonaws.com/abs/img/clients/donna.jpg"
    },
    {
        ...
        name: "Kevin T.",
        org: "MD",
        image: "https://cascadia-consultive.s3.us-west-2.amazonaws.com/abs/img/clients/kevin.jpg"
    },
    {
        ...
        name: "Keyvan K.",
        org: "MD",
        image: "https://cascadia-consultive.s3.us-west-2.amazonaws.com/abs/img/clients/keyvan.jpg"
    }
];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-4xl mx-auto relative">
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <img
                                    ...
                                    className="w-16 h-16 rounded-[4px] object-cover mb-6 border border-brand-light"
                                />
                    ...
                    <div className="flex justify-center gap-4 mt-8">
                        <button onClick={prev} className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-brand-navy shadow-md hover:bg-brand-navy hover:text-white transition-colors border-none">
                            <ChevronLeft />
                        </button>
                        <button onClick={next} className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-brand-navy shadow-md hover:bg-brand-navy hover:text-white transition-colors border-none">
                            <ChevronRight />
                        </button>
                    </div>
